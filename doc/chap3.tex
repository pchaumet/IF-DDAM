...
estpolarisée en TM et pola=0 en TE.  A noter que la polarisation n'est
pas forcément purement en TE ou TM: soit ${\rm pola}\in[0~1]$ tel que
$E^2_{\rm TM}={\rm pola}^2E^2$ et $E^2_{\rm TE}=(1-{\rm
  pola}^2)E^2$. Nous avons donc cette valeur entre 0 et 1, mais pour
des raisons simplicités nous avons deux valeurs particulères (2 et 3)
assignées à une polarisation pour champ orienté suivant $x$ ($y$) sans
que l'utilisateur ait à faire de calcul pour trouver pola.
