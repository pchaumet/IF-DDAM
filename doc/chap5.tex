...
``Position of the focal plane'' pour le microscope en transmission et
...
\caption{Schéma simplifié du microscope. Le foyer objet des lentilles
  ...
  être changés dans le code. L'axe des lentille est confondu avec l'axe
...
spéculaire transmis ou réfléchi suivant le configuration choisie)
