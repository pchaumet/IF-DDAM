...
c     ntorqued=1 ! calcul la desnite de couple dans l'objet l'objet.
      ...
      ndiffracte=0              ! 0 do not compute the diffracted far field, 1 compute the diffracted far field.
      ...
      zlensr=300.d0               ! Position of lens in reflexion.
      zlenst=-100.d0               ! Position of lens in transmission.
