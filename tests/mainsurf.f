...
c     parameter (nxm=3,nym=3,nzm=3,nphi=72,ntheta=35)
      parameter (nxm=40,nym=40,nzm=40,nphi=72,ntheta=36)
...
c*******************************************************
      ...
      nxmp=2 ! si boite plus large que l'objet suivant x
      nymp=3 ! si boite plus large que l'objet suivant y
      nzmp=4 ! si boite plus large que l'objet suivant z
      ...
      ninterp=2 ! niveau d'interpolation si tenseur non rigoureux
      ncote=1 ! 1 calcul des deux cotes le champ diffracté, 0 dessous, 2 dessus
      numaperref= 1.3d0! ouverture numerique mic. en reflexion
...
c     ntorqued=1 ! calcul la desnite de couple dans l'objet l'objet
      ...
      nenergie=1 !0: calcul du champ diffracte. 1 calcul du champ total
