...
public:
    ...
    QLOG_INFO() << "MyQwtPlotCurve::drawSymbols:data->size()=" << data->size();
    QLOG_INFO() << "MyQwtPlotCurve::drawSymbols:data->size()=" << datap->size();
    // Reconstruct symbols
...
PlotVector::~PlotVector() {
    QLOG_INFO() << "PlotVector::~PlotVector:: Deleting Plot";
    delete d_curve;
}
...
Plot::~Plot() {
    QLOG_INFO() << "Plot::~Plot:: Deleting Plot";
    delete data;
    delete colormap;
    delete cellVect;
    delete tripleVect;
