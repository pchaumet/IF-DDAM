      subroutine champlineairemicrokxky(eps,disz,neps,nepsmax,x,y,k0,E0
     $     ,ss,pp,kx,ky,infostr,nstop,Arx,Ary,Arz,Atx,Aty,Atz)
...
c     on eclaire par en dessous.
     ...
     $     ,k0d,pi,s,p,ss,pp
      double precision kx,ky,kp2,k02,ka,kz
