      subroutine inverserigsurfopt(xi,xr,nbsphere,ndipole,nx,ny,nz,nx2
     $     ,ny2,nxm,nym,nzm,nplanm,ntotalm,nmax,matindplan,b31
     $     ,b32,b33,FF,FF0,FFloc,b11,b12,b13,a11,a12,a13,a22,a23,a31,a32
...
c     write(*,*) 'ncompte',ncompte,nt,tole
         if (nt.eq.1) then
            call produitfftmatvectsurmopt(xi,xr,nbsphere,ndipole,nx,ny
     $           ,nz,nx2,ny2,nxm,nym,nzm,nzm,nplanm,ntotalm,nmax
     $           ,matindplan,b31,b32,b33,FF,b11,b12,b13,a11 ,a12 ,a13
     $           ,a22,a23,a31,a32 ,a33,polarisa,planb,planf)
            
         elseif (nt.eq.2) then
c     calcul avec le transpose                   
            call produitfftmatvectsurmopttrans(xi,xr,nbsphere,ndipole,nx
