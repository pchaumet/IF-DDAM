      subroutine objetcylindresurf(trope,eps,epsani,eps0,xs,ys,zs,xswf
...
c     shift the layers
         do k=nminc,nmaxc-1           
            do i=1,nnnr
               z=-demim/2.d0+aretecube*(dble(i)-0.5d0)+zg
