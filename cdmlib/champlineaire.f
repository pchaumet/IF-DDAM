      subroutine champlineaire(eps,disz,neps,nepsmax,x,y,z,k0,E0,ss,pp
     $     ,thetat,phit,infostr,nstop,Ex,Ey,Ez)
...
c     on eclaire par en dessous.
 ...
 900     job=11
     ...
     $              *wi(i+1)*z)
         ...
         Exx=p*E0x
         Eyy=s*E0x
         Ex=Exx*dcos(phi)-Eyy*dsin(phi)
         Ey=Eyy*dcos(phi)+Exx*dsin(phi)
         Ez=0.d0
         goto 999
      endif
