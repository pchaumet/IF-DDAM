      subroutine objetparainhomosurf(eps,xs,ys,zs,xswf,yswf,zswf ,k0
     $     ,aretecube ,tabdip,nnnr,nmax,nbsphere,ndipole,nx,ny,nz,nxm
     $     ,nym ,nzm,methode ,na ,epsilon,polarisa,sidex,sidey,sidez ,xg
     ...
     $     ,spec,moyenne,ecartype,lx,ly,lz,sunif,side,sidex,sidey,sidez
     $     ,xg ,yg,zg
