...
c     fluxinc=1/(2mu0c) *4*pi²/k0 *Int[ |A(k||)|² kz dk|| ]
      ...
      subroutine specklesurf(eps,zcouche,neps,nepsmax,k0,Amp,IR,xs,ys,zs
     $     ,x0,y0,z0,psi,FF0,aretecube,nx,ny,nz ,ndipole,nmax,nfft2d
     $     ,nfft2dmax ,Egausxref,Egausyref,Egauszref ,Egausxtra
     $     ,Egausytra ,Egausztra,fluxinc ,fluxref ,fluxtrans ,irra
     $     ,nstop ,infostr,planb)
      implicit none
...
c               write(*,*) 'FF0',FF0(kkk+1),FF0(kkk+2),zs(kk),kk
            enddo
         enddo
