...
!$OMP END PARALLEL   
     ...
     $                 ,Efourierincyneg,Efourierinczneg,nfft2d ,nfft2d
     $                 ,imaxk0 ,deltakx,deltax,gross,k0,indice0,plan2b)
